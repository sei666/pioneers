...
export const AddDiscussion = React.memo( function AddDiscussion(props){
    ...
    function handleOpenModalDiscussion(){
        dispatch(appSetModalAddDiscussionsShowBool(true));
    }
        ...
        <Fragment>
            ...
            <div className="addDiscussion">
                <div className="addDiscussion__fakeButton">
                    <div onClick={handleOpenModalDiscussion} className="addDiscussion__fakeButtonBorder">
                        <SVG src={plus}/>
                    </div>
                </div>
                ...
                <Button variant="outline-primary w-100" onClick={handleOpenModalDiscussion}>Create Thread</Button>
            </div>
